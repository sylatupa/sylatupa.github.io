...
function ServiceSetComment() {
    //public string SetComment(int DevId, string Comment, string CreatedBy) {
    var devId = $.urlParam('devId');
    var Comment = document.getElementById("TextareaComment").textContent;
    var CreatedBy = document.getElementById("inputCommentBy").value;
    Type = "POST";
    Url = "http://phx-gis-dev-ags/AppServices/Service1.svc/SetComment";
    Data = '{"DevId": "' + devId + '","Comment": "' + Comment + '", "CreatedBy": "' + CreatedBy + '"}';
...
function setCoordinate() {
    ...
    extent = new esri.geometry.Extent(pointMeters.x - 10000, pointMeters.y - 10000, pointMeters.x + 10000, pointMeters.y + 10000, pointMeters.spatialReference);
    graphic = new esri.Graphic(pointMeters, symbol);
