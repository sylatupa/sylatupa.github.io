...
function RandomData(processing) {
	...
	this.draw = function() {
		...
		this.frames = (this.frames <= 500 && this.pos_y > this.brick_start + 30) ? this.frames + 1 : this.frames;
		this.update = (this.frames < 500);
		if (this.update) {
...
function Slot(randomData, processing) {
	...
	slots.push(this);
	console.log("slot: " + this.name , " number1: " , this.pos_x , " number2: " , brick_end + 20 , " number3: " , this.get_pos_x(this.last_col+1) - this.pos_x );
} //end Slots object
// ATTACH TO CANVAS
